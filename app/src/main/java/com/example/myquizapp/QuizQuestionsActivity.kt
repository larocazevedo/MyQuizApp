...
class QuizQuestionsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    // criar uma variável global e a posição para obter a posição atual, terá que ser substituída
    // então outra variável e lista de perguntas
    private var mCurrentPosition: Int = 1
    private var mQuestionList: ArrayList<Question>? = null
    // precisa saber qual opção foi selecionada
    ...
    private fun setQuestion() {
        ...
        // em seguida, definimos a imagem, progress bar e opções de resposta
